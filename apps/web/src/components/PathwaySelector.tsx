...
export default function PathwaySelector({
  ...
  return (
    <section className="relative overflow-hidden rounded-3xl bg-white p-6 shadow-sm ring-1 ring-blue-100 sm:p-8">
      <div className="absolute inset-x-0 -top-28 flex justify-center opacity-10 blur-3xl">
        <div className="h-40 w-40 rounded-full bg-gradient-to-br from-blue-400 via-blue-500 to-blue-700" />
      </div>
            ...
            return (
              <button
                ...
                className={`group rounded-2xl border px-5 py-4 text-left transition focus-ring ${
                  isSelected
                    ...
                    : "border-blue-200 bg-white shadow-sm hover:border-blue-400 hover:shadow"
              ...
              >
                ...
                {isSelected && !comingSoon && (
                  <p className="mt-3 text-xs font-medium uppercase tracking-wide text-orange-600">
                    Selected pathway
                  </p>
                )}
              </button>
